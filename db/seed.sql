...
INSERT INTO `recettes` (`ID`, `categorie`, `titre`, `image`, `video`, `videos`, `description`, `saison`, `fete`, `temps_preparation`, `temps_cuisson`, `temps_repos`, `temps_total`, `calories`, `difficulte`, `notation`, `valide`) VALUES
(1, 'plats', 'Couscous aux légumes', 'https://images.unsplash.com/photo-1563379926898-05f4575a45d8?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Semoule vapeur, légumes de saison fondants dans un bouillon parfumé au ras el hanout — le plat convivial par excellence.', 'automne', 'aid', '30', '60', '10', '100', '420', 'moyenne', '5', 1),
(2, 'plats', 'Rfiss bel batata', 'https://images.unsplash.com/photo-1547592166-23ac45744acd?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Pommes de terre fondantes, sauce tomate épicée et viande tendre : réconfort d''hiver.', 'hiver', '', '25', '45', '0', '70', '380', 'facile', '4', 1),
(3, 'plats', 'Rechta au poulet', 'https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Pâtes fines maison, bouillon clair au safran et poulet mijoté — spécialité des fêtes familiales.', 'hiver', 'mouloud', '40', '50', '20', '110', '445', 'difficile', '5', 1),
(4, 'plats', 'Mhadjeb oranais', 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Crêpes feuilletées farcies à la harissa, tomates et herbes — croustillant et parfumé.', 'été', '', '35', '25', '30', '90', '295', 'moyenne', '4', 1),
(5, 'plats', 'Tajine de courgettes', 'https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Courgettes fondantes, œufs et épices douces en cocotte — léger et parfumé.', 'été', '', '20', '35', '0', '55', '220', 'facile', '4', 1),
(6, 'plats', 'Bourek à la viande', 'https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Feuilles de brick croustillantes, farce épicée — entrée chaude appréciée au ramadan.', 'printemps', 'ramadan', '45', '20', '0', '65', '310', 'moyenne', '5', 1),
(7, 'entrees', 'Chorba frik', 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Soupe épaisse au blé concassé, légumes et coriandre — réconfort des soirées d''hiver.', 'hiver', 'ramadan', '20', '40', '5', '65', '210', 'facile', '5', 1),
(8, 'entrees', 'Salade méchouia', 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Poivrons et tomates grillés, huile d''olive, ail et câpres — fraîcheur et fumé.', 'été', '', '15', '10', '0', '25', '120', 'facile', '4', 1),
(9, 'entrees', 'Harira marocaine', 'https://images.unsplash.com/photo-1603133872878-684f208fb84b?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Soupe nourrissante tomate, lentilles, pois chiches et vermicelle — repas complet.', 'automne', 'ramadan', '25', '45', '10', '80', '265', 'moyenne', '5', 1),
(10, 'entrees', 'Chakchouka', 'https://images.unsplash.com/photo-1598866594230-a7c12756260f?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Poivrons, tomates et œufs pochés — coloré et express pour un brunch.', 'printemps', '', '15', '20', '0', '35', '185', 'facile', '5', 1),
(11, 'entrees', 'Salade d''oranges à la cannelle', 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Oranges en tranches, miel, cannelle et fleur d''oranger — dessert d''agrumes rafraîchissant.', 'hiver', '', '12', '0', '15', '27', '95', 'facile', '3', 1),
(12, 'entrees', 'Soupe de lentilles corail', 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Velouté épicé au cumin, servi avec un filet de citron — équilibre et couleur.', 'automne', '', '10', '25', '0', '35', '155', 'facile', '4', 1),
(13, 'desserts', 'Makroud el louse', 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Gâteau aux amandes, parfumé à l''eau de fleur d''oranger et enrobé de miel.', 'printemps', 'aid', '40', '25', '120', '185', '310', 'moyenne', '5', 1),
(14, 'desserts', 'Sablés à la confiture', 'https://images.unsplash.com/photo-1499636136210-6f4ee915583e?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Petits sablés fondants pour le thé — confiture de figues ou d''abricots.', 'printemps', '', '35', '15', '30', '80', '180', 'facile', '3', 1),
(15, 'desserts', 'Baklawa aux amandes', 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Filo croustillant, sirop parfumé et amandes — sucrerie de partage.', 'hiver', 'aid', '50', '35', '60', '145', '385', 'difficile', '5', 1),
(16, 'desserts', 'Mhalbi à la fleur d''oranger', 'https://images.unsplash.com/photo-1563805042-7684c019e1cb?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Crème de riz parfumée, saupoudrée de cannelle — douceur glacée.', 'été', '', '15', '10', '240', '265', '195', 'facile', '4', 1),
(17, 'desserts', 'Griwech aux sésames', 'https://images.unsplash.com/photo-1495521821757-a1efb6729352?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Torsades frites enrobées de miel et graines de sésame — croquant sucré.', 'printemps', 'mouloud', '55', '25', '0', '80', '340', 'moyenne', '4', 1),
(18, 'boissons', 'Thé à la menthe', 'https://images.unsplash.com/photo-1564890369478-c89ca6d9cde9?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Thé vert, menthe fraîche et sucre — mousse à l''envi, rituel du partage.', 'été', '', '5', '10', '0', '15', '40', 'facile', '5', 1),
(19, 'boissons', 'Jus de bissap', 'https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Infusion d''hibiscus glacée, acidulée et profondément rouge.', 'été', '', '10', '5', '120', '135', '90', 'facile', '4', 1),
(20, 'boissons', 'Sharbat aux amandes', 'https://images.unsplash.com/photo-1546173159-315724a31696?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Lait d''amande maison, eau de rose et sucre — boisson opulente pour les fêtes.', 'printemps', 'aid', '15', '0', '60', '75', '210', 'facile', '4', 1),
(21, 'boissons', 'Lben maison', 'https://images.unsplash.com/photo-1488477181946-6428a0291777?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Boisson lactée fermentée, légèrement effervescente — digestion et fraîcheur.', 'été', '', '5', '0', '720', '725', '55', 'facile', '3', 1),
(22, 'boissons', 'Café aux dattes', 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?auto=format&fit=crop&w=1200&q=80', '', NULL, 'Expresso corsé servi avec une datte — équilibre amer-sucré.', 'automne', '', '3', '2', '0', '5', '35', 'facile', '4', 1);
